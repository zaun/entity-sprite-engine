 ...
 */
typedef enum {
    CONSOLE_NORMAL,    /**< Standard console output line */
    CONSOLE_INFO,      /**< Informational message */
 ...
 * 
 * @details The console manages a history of text lines with configurable display
 *          parameters. Internal structure is private to the implementation.
 */
 ...
 *          The console starts with an empty history and default display parameters.
 * 
 ...
 * 
 * @details Adds a new console line with the specified type, prefix, and message.
 *          If the history exceeds 1000 lines, the oldest line is automatically removed.
 *          The prefix is truncated to 16 characters if longer.
 * 
