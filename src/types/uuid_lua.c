 ...
 *
 * Provides read access to UUID properties (value, string) from Lua. When a Lua
 * script accesses uuid.value or uuid.string, this function is called to
 * retrieve the values. Also provides access to methods like reset.
 *
 * @param L Lua state
