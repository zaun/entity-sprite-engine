...
static void _ese_gui_style_set_lua_ref_count(EseGuiStyle *style,
                                             int lua_ref_count);
...
EseGuiStyle *_ese_gui_style_make(EseLuaEngine *engine) {
  log_assert("GUI_STYLE", engine != NULL,
             "ese_gui_style_create called with NULL engine");

  EseGuiStyle *style = (EseGuiStyle *)memory_manager.malloc(sizeof(EseGuiStyle),
                                                            MMTAG_GUI_STYLE);
  ...
  ese_color_set_hex(style->variant_active[GUI_STYLE_VARIANT_PRIMARY],
                    "#0a58ca");
  ese_color_set_hex(style->variant[GUI_STYLE_VARIANT_SECONDARY], "#6c757d");
  ese_color_set_hex(style->variant_hover[GUI_STYLE_VARIANT_SECONDARY],
                    "#5c636a");
  ese_color_set_hex(style->variant_active[GUI_STYLE_VARIANT_SECONDARY],
                    "#565e64");
  ese_color_set_hex(style->alert_bg_variant[GUI_STYLE_VARIANT_SUCCESS],
                    "#d1e7dd");
  ese_color_set_hex(style->alert_text_variant[GUI_STYLE_VARIANT_SUCCESS],
                    "#0f5132");
  ese_color_set_hex(style->alert_border_variant[GUI_STYLE_VARIANT_SUCCESS],
                    "#badbcc");
  ...
  ese_color_set_hex(style->variant_active[GUI_STYLE_VARIANT_WARNING],
                    "#ffdb6d");
  ...
  ese_color_set_hex(style->variant_hover[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#00000000");
  ese_color_set_hex(style->variant_active[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#00000000");

  // Alerts
  ese_color_set_hex(style->alert_bg_variant[GUI_STYLE_VARIANT_PRIMARY],
                    "#cfe2ff");
  ese_color_set_hex(style->alert_text_variant[GUI_STYLE_VARIANT_PRIMARY],
                    "#084298");
  ese_color_set_hex(style->alert_border_variant[GUI_STYLE_VARIANT_PRIMARY],
                    "#b6d4fe");
  ese_color_set_hex(style->alert_bg_variant[GUI_STYLE_VARIANT_SECONDARY],
                    "#e2e3e5");
  ese_color_set_hex(style->alert_text_variant[GUI_STYLE_VARIANT_SECONDARY],
                    "#41464b");
  ese_color_set_hex(style->alert_border_variant[GUI_STYLE_VARIANT_SECONDARY],
                    "#d3d6d8");
  ese_color_set_hex(style->alert_bg_variant[GUI_STYLE_VARIANT_SUCCESS],
                    "#d1e7dd");
  ese_color_set_hex(style->alert_text_variant[GUI_STYLE_VARIANT_SUCCESS],
  ...
  ese_color_set_hex(style->alert_text_variant[GUI_STYLE_VARIANT_INFO],
                    "#055160");
  ese_color_set_hex(style->alert_border_variant[GUI_STYLE_VARIANT_INFO],
                    "#b6effb");
  ese_color_set_hex(style->alert_bg_variant[GUI_STYLE_VARIANT_WARNING],
                    "#fff3cd");
  ese_color_set_hex(style->alert_text_variant[GUI_STYLE_VARIANT_WARNING],
                    "#664d03");
  ese_color_set_hex(style->alert_border_variant[GUI_STYLE_VARIANT_WARNING],
                    "#ffecb5");
  ese_color_set_hex(style->alert_bg_variant[GUI_STYLE_VARIANT_DANGER],
                    "#f8d7da");
  ese_color_set_hex(style->alert_text_variant[GUI_STYLE_VARIANT_DANGER],
                    "#842029");
  ese_color_set_hex(style->alert_border_variant[GUI_STYLE_VARIANT_DANGER],
                    "#f5c2c7");
  ese_color_set_hex(style->alert_bg_variant[GUI_STYLE_VARIANT_LIGHT],
                    "#fefefe");
  ese_color_set_hex(style->alert_text_variant[GUI_STYLE_VARIANT_LIGHT],
                    "#636464");
  ese_color_set_hex(style->alert_border_variant[GUI_STYLE_VARIANT_LIGHT],
                    "#fdfdfe");
  ese_color_set_hex(style->alert_bg_variant[GUI_STYLE_VARIANT_DARK], "#d3d3d4");
  ese_color_set_hex(style->alert_text_variant[GUI_STYLE_VARIANT_DARK],
                    "#141619");
  ese_color_set_hex(style->alert_border_variant[GUI_STYLE_VARIANT_DARK],
                    "#bcbebf");
  ese_color_set_hex(style->alert_bg_variant[GUI_STYLE_VARIANT_WHITE],
                    "#fcfcfd");
  ese_color_set_hex(style->alert_text_variant[GUI_STYLE_VARIANT_WHITE],
                    "#ffffff");
  ese_color_set_hex(style->alert_border_variant[GUI_STYLE_VARIANT_WHITE],
                    "#fdfdfe");
  ese_color_set_hex(style->alert_bg_variant[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#00000000");
  ese_color_set_hex(style->alert_text_variant[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#00000000");
  ese_color_set_hex(style->alert_border_variant[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#00000000");

  // Backgrounds
  ese_color_set_hex(style->bg_variant[GUI_STYLE_VARIANT_PRIMARY], "#0d6efd");
  ese_color_set_hex(style->bg_hover_variant[GUI_STYLE_VARIANT_PRIMARY],
                    "#0b5ed7");
  ese_color_set_hex(style->bg_active_variant[GUI_STYLE_VARIANT_PRIMARY],
                    "#0a58ca");
  ese_color_set_hex(style->bg_variant[GUI_STYLE_VARIANT_SECONDARY], "#6c757d");
  ese_color_set_hex(style->bg_hover_variant[GUI_STYLE_VARIANT_SECONDARY],
                    "#5c636a");
  ese_color_set_hex(style->bg_active_variant[GUI_STYLE_VARIANT_SECONDARY],
                    "#565e64");
  ese_color_set_hex(style->bg_variant[GUI_STYLE_VARIANT_SUCCESS], "#198754");
  ese_color_set_hex(style->bg_hover_variant[GUI_STYLE_VARIANT_SUCCESS],
                    "#157347");
  ese_color_set_hex(style->bg_active_variant[GUI_STYLE_VARIANT_SUCCESS],
                    "#146c43");
  ...
  ese_color_set_hex(style->bg_active_variant[GUI_STYLE_VARIANT_INFO],
                    "#3dd5f3");
  ese_color_set_hex(style->bg_variant[GUI_STYLE_VARIANT_WARNING], "#ffc107");
  ese_color_set_hex(style->bg_hover_variant[GUI_STYLE_VARIANT_WARNING],
                    "#ffcd39");
  ese_color_set_hex(style->bg_active_variant[GUI_STYLE_VARIANT_WARNING],
                    "#ffdb6d");
  ese_color_set_hex(style->bg_variant[GUI_STYLE_VARIANT_DANGER], "#dc3545");
  ese_color_set_hex(style->bg_hover_variant[GUI_STYLE_VARIANT_DANGER],
                    "#bb2d3b");
  ese_color_set_hex(style->bg_active_variant[GUI_STYLE_VARIANT_DANGER],
                    "#b02a37");
  ese_color_set_hex(style->bg_variant[GUI_STYLE_VARIANT_LIGHT], "#f8f9fa");
  ese_color_set_hex(style->bg_hover_variant[GUI_STYLE_VARIANT_LIGHT],
                    "#f9fafb");
  ese_color_set_hex(style->bg_active_variant[GUI_STYLE_VARIANT_LIGHT],
                    "#f9fafb");
  ...
  ese_color_set_hex(style->bg_active_variant[GUI_STYLE_VARIANT_DARK],
                    "#1a1e21");
  ese_color_set_hex(style->bg_variant[GUI_STYLE_VARIANT_WHITE], "#ffffff");
  ese_color_set_hex(style->bg_hover_variant[GUI_STYLE_VARIANT_WHITE],
                    "#f9fafb");
  ese_color_set_hex(style->bg_active_variant[GUI_STYLE_VARIANT_WHITE],
                    "#f9fafb");
  ese_color_set_hex(style->bg_variant[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#00000000");
  ese_color_set_hex(style->bg_hover_variant[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#00000000");
  ese_color_set_hex(style->bg_active_variant[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#00000000");

  // Text colors
  ese_color_set_hex(style->text_variant[GUI_STYLE_VARIANT_PRIMARY], "#0d6efd");
  ese_color_set_hex(style->text_hover_variant[GUI_STYLE_VARIANT_PRIMARY],
                    "#0a58ca");
  ese_color_set_hex(style->text_active_variant[GUI_STYLE_VARIANT_PRIMARY],
                    "#084298");
  ese_color_set_hex(style->text_variant[GUI_STYLE_VARIANT_SECONDARY],
                    "#6c757d");
  ese_color_set_hex(style->text_hover_variant[GUI_STYLE_VARIANT_SECONDARY],
                    "#565e64");
  ese_color_set_hex(style->text_active_variant[GUI_STYLE_VARIANT_SECONDARY],
                    "#343a40");
  ese_color_set_hex(style->text_variant[GUI_STYLE_VARIANT_SUCCESS], "#198754");
  ese_color_set_hex(style->text_hover_variant[GUI_STYLE_VARIANT_SUCCESS],
                    "#157347");
  ese_color_set_hex(style->text_active_variant[GUI_STYLE_VARIANT_SUCCESS],
                    "#0f5132");
  ese_color_set_hex(style->text_variant[GUI_STYLE_VARIANT_INFO], "#0dcaf0");
  ese_color_set_hex(style->text_hover_variant[GUI_STYLE_VARIANT_INFO],
                    "#055160");
  ese_color_set_hex(style->text_active_variant[GUI_STYLE_VARIANT_INFO],
                    "#0a58ca");
  ese_color_set_hex(style->text_variant[GUI_STYLE_VARIANT_WARNING], "#ffc107");
  ese_color_set_hex(style->text_hover_variant[GUI_STYLE_VARIANT_WARNING],
                    "#ffcd39");
  ese_color_set_hex(style->text_active_variant[GUI_STYLE_VARIANT_WARNING],
                    "#664d03");
  ese_color_set_hex(style->text_variant[GUI_STYLE_VARIANT_DANGER], "#dc3545");
  ese_color_set_hex(style->text_hover_variant[GUI_STYLE_VARIANT_DANGER],
                    "#b02a37");
  ese_color_set_hex(style->text_active_variant[GUI_STYLE_VARIANT_DANGER],
                    "#842029");
  ese_color_set_hex(style->text_variant[GUI_STYLE_VARIANT_LIGHT], "#f8f9fa");
  ese_color_set_hex(style->text_hover_variant[GUI_STYLE_VARIANT_LIGHT],
                    "#343a40");
  ese_color_set_hex(style->text_active_variant[GUI_STYLE_VARIANT_LIGHT],
                    "#495057");
  ese_color_set_hex(style->text_variant[GUI_STYLE_VARIANT_DARK], "#212529");
  ese_color_set_hex(style->text_hover_variant[GUI_STYLE_VARIANT_DARK],
                    "#18191a");
  ese_color_set_hex(style->text_active_variant[GUI_STYLE_VARIANT_DARK],
                    "#0f0f10");
  ese_color_set_hex(style->text_variant[GUI_STYLE_VARIANT_WHITE], "#ffffff");
  ese_color_set_hex(style->text_hover_variant[GUI_STYLE_VARIANT_WHITE],
                    "#e9ecef");
  ese_color_set_hex(style->text_active_variant[GUI_STYLE_VARIANT_WHITE],
                    "#dee2e6");
  ese_color_set_hex(style->text_variant[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#000000");
  ese_color_set_hex(style->text_hover_variant[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#000000");
  ese_color_set_hex(style->text_active_variant[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#000000");

  // Borders
  ese_color_set_hex(style->border_variant[GUI_STYLE_VARIANT_PRIMARY],
                    "#0d6efd");
  ese_color_set_hex(style->border_hover_variant[GUI_STYLE_VARIANT_PRIMARY],
                    "#0a58ca");
  ese_color_set_hex(style->border_active_variant[GUI_STYLE_VARIANT_PRIMARY],
                    "#084298");
  ese_color_set_hex(style->border_variant[GUI_STYLE_VARIANT_SECONDARY],
                    "#6c757d");
  ese_color_set_hex(style->border_hover_variant[GUI_STYLE_VARIANT_SECONDARY],
                    "#565e64");
  ese_color_set_hex(style->border_active_variant[GUI_STYLE_VARIANT_SECONDARY],
                    "#343a40");
  ese_color_set_hex(style->border_variant[GUI_STYLE_VARIANT_SUCCESS],
                    "#198754");
  ese_color_set_hex(style->border_hover_variant[GUI_STYLE_VARIANT_SUCCESS],
                    "#0f5132");
  ese_color_set_hex(style->border_active_variant[GUI_STYLE_VARIANT_SUCCESS],
                    "#14532d");
  ese_color_set_hex(style->border_variant[GUI_STYLE_VARIANT_INFO], "#0dcaf0");
  ese_color_set_hex(style->border_hover_variant[GUI_STYLE_VARIANT_INFO],
                    "#055160");
  ese_color_set_hex(style->border_active_variant[GUI_STYLE_VARIANT_INFO],
                    "#31d2f2");
  ese_color_set_hex(style->border_variant[GUI_STYLE_VARIANT_WARNING],
                    "#ffc107");
  ese_color_set_hex(style->border_hover_variant[GUI_STYLE_VARIANT_WARNING],
                    "#ffcd39");
  ese_color_set_hex(style->border_active_variant[GUI_STYLE_VARIANT_WARNING],
                    "#664d03");
  ese_color_set_hex(style->border_variant[GUI_STYLE_VARIANT_DANGER], "#dc3545");
  ese_color_set_hex(style->border_hover_variant[GUI_STYLE_VARIANT_DANGER],
                    "#b02a37");
  ese_color_set_hex(style->border_active_variant[GUI_STYLE_VARIANT_DANGER],
                    "#842029");
  ese_color_set_hex(style->border_variant[GUI_STYLE_VARIANT_LIGHT], "#f8f9fa");
  ese_color_set_hex(style->border_hover_variant[GUI_STYLE_VARIANT_LIGHT],
                    "#dee2e6");
  ese_color_set_hex(style->border_active_variant[GUI_STYLE_VARIANT_LIGHT],
                    "#ced4da");
  ese_color_set_hex(style->border_variant[GUI_STYLE_VARIANT_DARK], "#212529");
  ese_color_set_hex(style->border_hover_variant[GUI_STYLE_VARIANT_DARK],
                    "#18191a");
  ese_color_set_hex(style->border_active_variant[GUI_STYLE_VARIANT_DARK],
                    "#0f0f10");
  ese_color_set_hex(style->border_variant[GUI_STYLE_VARIANT_WHITE], "#ffffff");
  ese_color_set_hex(style->border_hover_variant[GUI_STYLE_VARIANT_WHITE],
                    "#e9ecef");
  ese_color_set_hex(style->border_active_variant[GUI_STYLE_VARIANT_WHITE],
                    "#dee2e6");
  ese_color_set_hex(style->border_variant[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#00000000");
  ese_color_set_hex(style->border_hover_variant[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#00000000");
  ese_color_set_hex(style->border_active_variant[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#00000000");

  // Tooltips
  ese_color_set_hex(style->tooltip_bg_variant[GUI_STYLE_VARIANT_PRIMARY],
                    "#0d6efd");
  ese_color_set_hex(style->tooltip_color_variant[GUI_STYLE_VARIANT_PRIMARY],
                    "#ffffff");
  ese_color_set_hex(style->tooltip_bg_variant[GUI_STYLE_VARIANT_SECONDARY],
                    "#6c757d");
  ese_color_set_hex(style->tooltip_color_variant[GUI_STYLE_VARIANT_SECONDARY],
                    "#ffffff");
  ese_color_set_hex(style->tooltip_bg_variant[GUI_STYLE_VARIANT_SUCCESS],
                    "#198754");
  ese_color_set_hex(style->tooltip_color_variant[GUI_STYLE_VARIANT_SUCCESS],
                    "#ffffff");
  ese_color_set_hex(style->tooltip_bg_variant[GUI_STYLE_VARIANT_INFO],
                    "#0dcaf0");
  ese_color_set_hex(style->tooltip_color_variant[GUI_STYLE_VARIANT_INFO],
                    "#000000");
  ese_color_set_hex(style->tooltip_bg_variant[GUI_STYLE_VARIANT_WARNING],
                    "#ffc107");
  ese_color_set_hex(style->tooltip_color_variant[GUI_STYLE_VARIANT_WARNING],
                    "#000000");
  ese_color_set_hex(style->tooltip_bg_variant[GUI_STYLE_VARIANT_DANGER],
                    "#dc3545");
  ese_color_set_hex(style->tooltip_color_variant[GUI_STYLE_VARIANT_DANGER],
                    "#ffffff");
  ese_color_set_hex(style->tooltip_bg_variant[GUI_STYLE_VARIANT_LIGHT],
                    "#f8f9fa");
  ese_color_set_hex(style->tooltip_color_variant[GUI_STYLE_VARIANT_LIGHT],
                    "#000000");
  ese_color_set_hex(style->tooltip_bg_variant[GUI_STYLE_VARIANT_DARK],
                    "#212529");
  ese_color_set_hex(style->tooltip_color_variant[GUI_STYLE_VARIANT_DARK],
                    "#ffffff");
  ese_color_set_hex(style->tooltip_bg_variant[GUI_STYLE_VARIANT_WHITE],
                    "#ffffff");
  ese_color_set_hex(style->tooltip_color_variant[GUI_STYLE_VARIANT_WHITE],
                    "#000000");
  ese_color_set_hex(style->tooltip_bg_variant[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#00000000");
  ese_color_set_hex(style->tooltip_color_variant[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#000000");

  // Miscellaneous
  ese_color_set_hex(style->selection_bg_variant[GUI_STYLE_VARIANT_PRIMARY],
                    "#b6d4fe");
  ese_color_set_hex(style->selection_color_variant[GUI_STYLE_VARIANT_PRIMARY],
                    "#084298");
  ese_color_set_hex(style->selection_bg_variant[GUI_STYLE_VARIANT_SECONDARY],
                    "#e2e3e5");
  ese_color_set_hex(style->selection_color_variant[GUI_STYLE_VARIANT_SECONDARY],
                    "#41464b");
  ese_color_set_hex(style->selection_bg_variant[GUI_STYLE_VARIANT_SUCCESS],
                    "#badbcc");
  ese_color_set_hex(style->selection_color_variant[GUI_STYLE_VARIANT_SUCCESS],
                    "#0f5132");
  ese_color_set_hex(style->selection_bg_variant[GUI_STYLE_VARIANT_INFO],
                    "#b6effb");
  ese_color_set_hex(style->selection_color_variant[GUI_STYLE_VARIANT_INFO],
                    "#055160");
  ese_color_set_hex(style->selection_bg_variant[GUI_STYLE_VARIANT_WARNING],
                    "#ffecb5");
  ese_color_set_hex(style->selection_color_variant[GUI_STYLE_VARIANT_WARNING],
                    "#664d03");
  ese_color_set_hex(style->selection_bg_variant[GUI_STYLE_VARIANT_DANGER],
                    "#f5c2c7");
  ese_color_set_hex(style->selection_color_variant[GUI_STYLE_VARIANT_DANGER],
                    "#842029");
  ese_color_set_hex(style->selection_bg_variant[GUI_STYLE_VARIANT_LIGHT],
                    "#f8f9fa");
  ese_color_set_hex(style->selection_color_variant[GUI_STYLE_VARIANT_LIGHT],
                    "#636464");
  ese_color_set_hex(style->selection_bg_variant[GUI_STYLE_VARIANT_DARK],
                    "#bcbebf");
  ese_color_set_hex(style->selection_color_variant[GUI_STYLE_VARIANT_DARK],
                    "#141619");
  ese_color_set_hex(style->selection_bg_variant[GUI_STYLE_VARIANT_WHITE],
                    "#ffffff");
  ese_color_set_hex(style->selection_color_variant[GUI_STYLE_VARIANT_WHITE],
                    "#141619");
  ese_color_set_hex(style->selection_bg_variant[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#00000000");
  ese_color_set_hex(
      style->selection_color_variant[GUI_STYLE_VARIANT_TRANSPARENT],
      "#00000000");

  // Focus ring
  ese_color_set_hex(style->focus_ring_variant[GUI_STYLE_VARIANT_PRIMARY],
                    "#0d6efd");
  ese_color_set_hex(style->focus_ring_variant[GUI_STYLE_VARIANT_SECONDARY],
                    "#6c757d");
  ese_color_set_hex(style->focus_ring_variant[GUI_STYLE_VARIANT_SUCCESS],
                    "#198754");
  ese_color_set_hex(style->focus_ring_variant[GUI_STYLE_VARIANT_INFO],
                    "#0dcaf0");
  ese_color_set_hex(style->focus_ring_variant[GUI_STYLE_VARIANT_WARNING],
                    "#ffc107");
  ese_color_set_hex(style->focus_ring_variant[GUI_STYLE_VARIANT_DANGER],
                    "#dc3545");
  ese_color_set_hex(style->focus_ring_variant[GUI_STYLE_VARIANT_LIGHT],
                    "#f8f9fa");
  ese_color_set_hex(style->focus_ring_variant[GUI_STYLE_VARIANT_DARK],
                    "#212529");
  ese_color_set_hex(style->focus_ring_variant[GUI_STYLE_VARIANT_WHITE],
                    "#ffffff");
  ese_color_set_hex(style->focus_ring_variant[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#00000000");

  // Highlight
  ese_color_set_hex(style->highlight_variant[GUI_STYLE_VARIANT_PRIMARY],
                    "#b6d4fe");
  ese_color_set_hex(style->highlight_variant[GUI_STYLE_VARIANT_SECONDARY],
                    "#e2e3e5");
  ese_color_set_hex(style->highlight_variant[GUI_STYLE_VARIANT_SUCCESS],
                    "#badbcc");
  ese_color_set_hex(style->highlight_variant[GUI_STYLE_VARIANT_INFO],
                    "#b6effb");
  ese_color_set_hex(style->highlight_variant[GUI_STYLE_VARIANT_WARNING],
                    "#ffecb5");
  ese_color_set_hex(style->highlight_variant[GUI_STYLE_VARIANT_DANGER],
                    "#f5c2c7");
  ese_color_set_hex(style->highlight_variant[GUI_STYLE_VARIANT_LIGHT],
                    "#fdfdfe");
  ese_color_set_hex(style->highlight_variant[GUI_STYLE_VARIANT_DARK],
                    "#bcbebf");
  ese_color_set_hex(style->highlight_variant[GUI_STYLE_VARIANT_WHITE],
                    "#fdfdfe");
  ese_color_set_hex(style->highlight_variant[GUI_STYLE_VARIANT_TRANSPARENT],
                    "#00000000");
...
EseGuiStyle *ese_gui_style_copy(const EseGuiStyle *source) {
  log_assert("GUI_STYLE", source != NULL,
             "ese_gui_style_copy called with NULL source");

  EseLuaEngine *engine = NULL;
  if (source->state) {
    engine = (EseLuaEngine *)lua_engine_get_registry_key(source->state,
                                                         LUA_ENGINE_KEY);
  }
  ...
  for (int i = 0; i < GUI_STYLE_VARIANT_MAX; i++) {
    ...
    SET_COLOR(copy->selection_color_variant[i],
              source->selection_color_variant[i]);
...
EseColor *ese_gui_style_get_color(const EseGuiStyle *style,
  ...
  log_assert("GUI_STYLE", style != NULL, "NULL style parameter");
  log_assert("GUI_STYLE", variant >= 0 && variant < GUI_STYLE_VARIANT_MAX,
             "Invalid variant");
...
bool ese_gui_style_add_watcher(EseGuiStyle *style,
  ...
  if (style->watcher_count >= style->watcher_capacity) {
    size_t new_capacity =
        style->watcher_capacity == 0 ? 4 : style->watcher_capacity * 2;
    ...
    void **new_userdata = (void **)memory_manager.realloc(
        style->watcher_userdata, sizeof(void *) * new_capacity,
        MMTAG_GUI_STYLE);
    if (!new_userdata) {
...
bool ese_gui_style_remove_watcher(EseGuiStyle *style,
  ...
  for (size_t i = 0; i < style->watcher_count; i++) {
    if (style->watchers[i] == callback &&
        style->watcher_userdata[i] == userdata) {
...
cJSON *ese_gui_style_serialize(const EseGuiStyle *style) {
  ...
  cJSON_AddNumberToObject(json, "padding_bottom",
                          (double)style->padding_bottom);
...
EseGuiStyle *ese_gui_style_deserialize(EseLuaEngine *engine,
                                       const cJSON *data) {
  log_assert("GUI_STYLE", engine != NULL,
             "ese_gui_style_deserialize called with NULL engine");
  log_assert("GUI_STYLE", data != NULL,
             "ese_gui_style_deserialize called with NULL data");

  // Check if this is a GUI_STYLE object
  cJSON *type = cJSON_GetObjectItemCaseSensitive(data, "type");
  if (!type || !cJSON_IsString(type) ||
      strcmp(type->valuestring, "GUI_STYLE") != 0) {
    return NULL;
  }
  ...
  cJSON *padding_right =
      cJSON_GetObjectItemCaseSensitive(data, "padding_right");
  if (cJSON_IsNumber(padding_right)) {
    style->padding_right = padding_right->valueint;
  }

  cJSON *padding_bottom =
      cJSON_GetObjectItemCaseSensitive(data, "padding_bottom");
