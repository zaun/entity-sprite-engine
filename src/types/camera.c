 ...
 */
EsePoint *ese_camera_get_position(const EseCamera *camera_state) { return camera_state->position; }
 ...
 */
float ese_camera_get_rotation(const EseCamera *camera_state) { return camera_state->rotation; }
 ...
 */
float ese_camera_get_scale(const EseCamera *camera_state) { return camera_state->scale; }
 ...
 */
lua_State *ese_camera_get_state(const EseCamera *camera_state) { return camera_state->state; }
 ...
 */
int ese_camera_get_lua_ref(const EseCamera *camera_state) { return camera_state->lua_ref; }
...
void ese_camera_lua_push(EseCamera *camera_state) {
    ...
    if (ese_camera_get_lua_ref(camera_state) == LUA_NOREF) {
        ...
        EseCamera **ud =
            (EseCamera **)lua_newuserdata(ese_camera_get_state(camera_state), sizeof(EseCamera *));
        *ud = camera_state;
