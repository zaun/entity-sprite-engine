...
// shaderStage: 0=vertex,1=tess control,2=tess
// eval,3=geometry,4=fragment,5=compute Returns ShaderBlob with allocated data
// buffer. Free with free_shader_blob.
...
// Compile GLSL source to Metal Shading Language string (via SPIR-V
// intermediate). Returns null-terminated string allocated on heap. Free with
// free_shader_blob.
