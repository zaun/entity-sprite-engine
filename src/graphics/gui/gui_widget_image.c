...
static bool _image_process_mouse_click(EseGuiWidget *widget, int mouse_x, int mouse_y,
...
static int _image_lua_push(lua_State *L) {
    ...
    EseGuiWidget *image =
        _image_create(parent, ese_gui_style_copy(opt_style ? opt_style : gui->default_style));
