...
static EseInputKey mapGLFWKeyToInputKey(int key) {
    switch (key) {
        case GLFW_KEY_A: return InputKey_A;
        case GLFW_KEY_B: return InputKey_B;
        case GLFW_KEY_C: return InputKey_C;
        case GLFW_KEY_D: return InputKey_D;
        case GLFW_KEY_E: return InputKey_E;
        case GLFW_KEY_F: return InputKey_F;
        case GLFW_KEY_G: return InputKey_G;
        case GLFW_KEY_H: return InputKey_H;
        case GLFW_KEY_I: return InputKey_I;
        case GLFW_KEY_J: return InputKey_J;
        case GLFW_KEY_K: return InputKey_K;
        case GLFW_KEY_L: return InputKey_L;
        case GLFW_KEY_M: return InputKey_M;
        case GLFW_KEY_N: return InputKey_N;
        case GLFW_KEY_O: return InputKey_O;
        case GLFW_KEY_P: return InputKey_P;
        case GLFW_KEY_Q: return InputKey_Q;
        case GLFW_KEY_R: return InputKey_R;
        case GLFW_KEY_S: return InputKey_S;
        case GLFW_KEY_T: return InputKey_T;
        case GLFW_KEY_U: return InputKey_U;
        case GLFW_KEY_V: return InputKey_V;
        case GLFW_KEY_W: return InputKey_W;
        case GLFW_KEY_X: return InputKey_X;
        case GLFW_KEY_Y: return InputKey_Y;
        case GLFW_KEY_Z: return InputKey_Z;

        case GLFW_KEY_0: return InputKey_0;
        case GLFW_KEY_1: return InputKey_1;
        case GLFW_KEY_2: return InputKey_2;
        case GLFW_KEY_3: return InputKey_3;
        case GLFW_KEY_4: return InputKey_4;
        case GLFW_KEY_5: return InputKey_5;
        case GLFW_KEY_6: return InputKey_6;
        case GLFW_KEY_7: return InputKey_7;
        case GLFW_KEY_8: return InputKey_8;
        case GLFW_KEY_9: return InputKey_9;

        case GLFW_KEY_F1: return InputKey_F1;
        case GLFW_KEY_F2: return InputKey_F2;
        case GLFW_KEY_F3: return InputKey_F3;
        case GLFW_KEY_F4: return InputKey_F4;
        case GLFW_KEY_F5: return InputKey_F5;
        case GLFW_KEY_F6: return InputKey_F6;
        case GLFW_KEY_F7: return InputKey_F7;
        case GLFW_KEY_F8: return InputKey_F8;
        case GLFW_KEY_F9: return InputKey_F9;
        case GLFW_KEY_F10: return InputKey_F10;
        case GLFW_KEY_F11: return InputKey_F11;
        case GLFW_KEY_F12: return InputKey_F12;

        case GLFW_KEY_UP: return InputKey_UP;
        case GLFW_KEY_DOWN: return InputKey_DOWN;
        case GLFW_KEY_LEFT: return InputKey_LEFT;
        case GLFW_KEY_RIGHT: return InputKey_RIGHT;

        case GLFW_KEY_SPACE: return InputKey_SPACE;
        case GLFW_KEY_ENTER: return InputKey_ENTER;
        case GLFW_KEY_ESCAPE: return InputKey_ESCAPE;
        case GLFW_KEY_TAB: return InputKey_TAB;
        case GLFW_KEY_BACKSPACE: return InputKey_BACKSPACE;
        case GLFW_KEY_CAPS_LOCK: return InputKey_CAPSLOCK;
...
static void glfw_key_callback(GLFWwindow *w, int key, int scancode,
    ...
    // update modifiers
    pw->inputState->keys_down[InputKey_LSHIFT] =
        (mods & GLFW_MOD_SHIFT) != 0;
    pw->inputState->keys_down[InputKey_RSHIFT] =
        (mods & GLFW_MOD_SHIFT) != 0;

    pw->inputState->keys_down[InputKey_LCTRL] =
        (mods & GLFW_MOD_CONTROL) != 0;
    pw->inputState->keys_down[InputKey_RCTRL] =
        (mods & GLFW_MOD_CONTROL) != 0;

    pw->inputState->keys_down[InputKey_LALT] =
        (mods & GLFW_MOD_ALT) != 0;
    pw->inputState->keys_down[InputKey_RALT] =
        (mods & GLFW_MOD_ALT) != 0;

    pw->inputState->keys_down[InputKey_LCMD] =
        (mods & GLFW_MOD_SUPER) != 0;
    pw->inputState->keys_down[InputKey_RCMD] =
        (mods & GLFW_MOD_SUPER) != 0;
    ...
    if (ik == InputKey_UNKNOWN || ik >= InputKey_MAX) return;
...
static void glfw_mouse_button_callback(GLFWwindow *w, int button,
                                       int action, int mods) {
    EseGLFWWindow *pw = (EseGLFWWindow *)glfwGetWindowUserPointer(w);
    if (!pw || !pw->inputState) return;
...
// Callback: scroll
static void glfw_scroll_callback(GLFWwindow *w, double xoffset, double yoffset) {
    EseGLFWWindow *pw = (EseGLFWWindow *)glfwGetWindowUserPointer(w);
    if (!pw || !pw->inputState) return;
...
void window_set_renderer(EseWindow *window, EseRenderer *renderer) {
    ...
    if (renderer->hiDPI) {
        // Get the actual framebuffer size (pixels) immediately after window creation
        int framebuffer_width, framebuffer_height;
        glfwGetFramebufferSize(pw->glfw_window, &framebuffer_width, &framebuffer_height);
...
void window_process(EseWindow *window, EseInputState *out_input_state) {
    if (!window || !out_input_state) return;
    EseGLFWWindow *pw = (EseGLFWWindow *)window->platform_window;
