 ...
 *
 * @param free_fn Optional function to free values when they are removed or the
 * map is cleared/freed. Pass NULL if values should not be freed automatically.
 ...
 *
 * Does free the values pointed to by the map if a free function is provided.
 *
 ...
 * @param map Pointer to the EseHashMap.
 * @param key Null-terminated string key.
 * @return Pointer to the value associated with the removed key, or NULL if not
 * found.
 */
