...
EseDListIter *dlist_iter_create(EseDoubleLinkedList *list) {
    ...
    EseDListIter *iter = memory_manager.malloc(sizeof(EseDListIter), MMTAG_LINKED_LIST_ITER);
...
EseDListIter *dlist_iter_create_from(EseDListIter *iter) {
    ...
    EseDListIter *new_iter = memory_manager.malloc(sizeof(EseDListIter), MMTAG_LINKED_LIST_ITER);
