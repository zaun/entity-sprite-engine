...
static const char *STANDARD_FUNCTIONS[] = {"entity_init", "entity_update", "entity_collision_enter",
...
static bool _lua_vtable_run_function(EseEntityComponent *component, EseEntity *entity,
    ...
    return entity_component_lua_run((EseEntityComponentLua *)component->data, entity, func_name,
                                    argc, (EseLuaValue **)argv);
}

static void _lua_vtable_collides_component(EseEntityComponent *a, EseEntityComponent *b,
                                           EseArray *out_hits) {
    (void)a;
    (void)b;
    (void)out_hits;
...
bool entity_component_lua_run(EseEntityComponentLua *component, EseEntity *entity,
    ...
    bool result = lua_engine_run_function_ref(component->engine, cached->function_ref,
...
EseEntityComponentLua *_entity_component_lua_get(lua_State *L, int idx) {
    ...
    EseEntityComponentLua **ud =
        (EseEntityComponentLua **)luaL_testudata(L, idx, ENTITY_COMPONENT_LUA_PROXY_META);
    if (!ud) {
...
void _entity_component_lua_init(EseLuaEngine *engine) {
    ...
    // Create metatable
    lua_engine_new_object_meta(engine, ENTITY_COMPONENT_LUA_PROXY_META, _entity_component_lua_index,
