...
bool _entity_component_map_run(EseEntityComponentMap *component, EseEntity *entity,
...
static void _map_vtable_draw(EseEntityComponent *component, int screen_x, int screen_y,
    ...
    _entity_component_map_draw((EseEntityComponentMap *)component->data, screen_x, screen_y,
                               draw_callbacks->draw_texture, user_data);
}
...
void _entity_component_map_update(EseEntityComponentMap *component, EseEntity *entity,
    ...
    // Keep world bounds in sync so spatial index can pair map entities
    // correctly
...
void _entity_component_map_draw_grid(EseEntityComponentMap *component, float screen_x,
...
void _entity_component_map_draw_hex_point_up(EseEntityComponentMap *component, float screen_x,
                                             float screen_y, EntityDrawTextureCallback texCallback,
                                             void *callback_user_data) {
    EseEngine *engine =
        (EseEngine *)lua_engine_get_registry_key(component->base.lua->runtime, ENGINE_KEY);
...
void _entity_component_map_draw_hex_flat_up(EseEntityComponentMap *component, float screen_x,
                                            float screen_y, EntityDrawTextureCallback texCallback,
                                            void *callback_user_data) {
    EseEngine *engine =
        (EseEngine *)lua_engine_get_registry_key(component->base.lua->runtime, ENGINE_KEY);
...
void _entity_component_map_draw_iso(EseEntityComponentMap *component, float screen_x,
                                    float screen_y, EntityDrawTextureCallback texCallback,
                                    void *callback_user_data) {
    EseEngine *engine =
        (EseEngine *)lua_engine_get_registry_key(component->base.lua->runtime, ENGINE_KEY);
...
void _entity_component_map_draw(EseEntityComponentMap *component, float screen_x, float screen_y,
    ...
    case MAP_TYPE_HEX_POINT_UP:
        _entity_component_map_draw_hex_point_up(component, screen_x, screen_y, texCallback,
                                                callback_user_data);
        break;
    case MAP_TYPE_HEX_FLAT_UP:
        _entity_component_map_draw_hex_flat_up(component, screen_x, screen_y, texCallback,
                                               callback_user_data);
        break;
    case MAP_TYPE_ISO:
